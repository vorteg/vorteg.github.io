...
export const info = {
    ...
    skills:
    {
        proficientWith: ['Technical Lead Python Developer & Computer Vision(AI / ML)', ' Senior Python developer', 'Full Stack developer', 'Software Engineer Developer lead', 'System Validation engineer', 'Program Manager Intern', 'Hardware Technician'],
        exposedTo: ['python', 'django', 'flask', 'fastapi', 'pandas', 'jupyter notebook', 'computer vision', 'deep learning', 'pytorch', 'react', 'nextjs', 'nodejs', 'javascript', 'typescript', ' and more']
    }
    ,
    hobbies: [
